                                        ...
                                        <table cellspacing="0" cellpadding="0" class="force-full-width">
                                            ...
                                            <tr>
                                                <td style="font-size:24px; text-align:center; padding: 0 75px; color:#6f6f6f;" class="w320 mobile-spacing">
                                                    We sent this email to inform you about your new account created by {{$sender}}.<br/>
                                                    You Can Login Using:<br/>
                                                    Email: {{$to_email}}<br/>
                                                    Password: {{$password}}<br/>

                                                    You MUST Change Your Password After Login<br/>
                                                </td>
                                            </tr>
                                        </table>
                    ...
                    <td style="text-align:center; margin:0 auto;">
                        ...
                        <div><!--[if mso]>
                            ...
                            <a href="http://localhost:3000/login"
                               style="background-color:#3B87FF;color:#ffffff;display:inline-block;font-family:'Source Sans Pro', Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:45px;text-align:center;text-decoration:none;width:180px;-webkit-text-size-adjust:none;">Enter Your Account</a>
                            <!--[if mso]>
                            </center>
                            </v:rect>
                            <![endif]--></div>

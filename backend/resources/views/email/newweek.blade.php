                                ...
                                <tr>
                                    <td style="background-color:#ffffff;">
                                        ...
                                        <table cellspacing="0" cellpadding="0" class="force-full-width">
                                            <tr>
                                                <td style="font-size:40px; font-weight: 600; color: #1bd1f5; text-align:center;" class="mobile-spacing">
                                                    <div class="mobile-br">&nbsp;</div>
                                                    New Week Have Been Created Get Ready                    <br>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="font-size:24px; text-align:center; padding: 0 75px; color:#6f6f6f;" class="w320 mobile-spacing">
                                                    we sent this email to inform you about new week created by your teacher please study your material and then solve your homeworks.                    </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="100%">
                                            <tr>
                                                <td>
                                                    <img src="https://i.ibb.co/kqt7tMY/main.jpg" style="max-width:100%; display:block;">
                                                </td>
                                            </tr>
                                        </table>
                    ...
                    <td style="text-align:center; margin:0 auto;">
                        ...
                        <div><!--[if mso]>
                            ...
                            <a href="http://localhost:3000/"
                               style="background-color:#3B87FF;color:#ffffff;display:inline-block;font-family:'Source Sans Pro', Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:45px;text-align:center;text-decoration:none;width:180px;-webkit-text-size-adjust:none;">Go To Your Class</a>
                            <!--[if mso]>
                            </center>
                            </v:rect>
                            <![endif]--></div>
